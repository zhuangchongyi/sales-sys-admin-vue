<template>
    <div>
        <div class="container">
            <el-form :inline="true">
                <el-form-item label="">
                    <el-input v-model="queryParams.categoryNum" placeholder="客户类别编码" clearable size="small" @keyup.enter.native="handleQuery" />
                </el-form-item>
                <el-form-item label="">
                    <el-input v-model="queryParams.categoryName" placeholder="客户类别名称" clearable size="small" @keyup.enter.native="handleQuery" />
                </el-form-item>
                <el-form-item label="">
            ...
            <el-table style="width: 100%" v-loading="loading" :data="categoryListData" row-key="categoryId" default-expand-all :tree-props="{ children: 'children', hasChildren: 'hasChildren' }">
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini" type="text" icon="el-icon-plus" v-hasPermi="['basis:clienteleType:add']" @click="handleAdd(scope.row)">新增</el-button>
                        <el-button
                            ...
                            icon="el-icon-delete"
                            style="color:#fd5656"
                            v-hasPermi="['basis:clienteleType:delete']"
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="类别编码" prop="categoryNum">
                                <el-input v-model="form.categoryNum" placeholder="请输入客户类别名称" maxlength="10" show-word-limit :readonly="isEdit" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
