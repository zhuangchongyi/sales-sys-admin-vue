<template>
    <div class="container">
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="退货人员" prop="personnelName">
                        <el-input v-model="clienteleForm.personnelName" size="small" placeholder="请选择" style="width: 155px;" readonly />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="returnsNum" width="150" label="本次退货数量" align="center"> </el-table-column>
