<template>
    <div class="container">
        ...
        <el-form :model="clienteleForm" ref="clienteleForm" label-position="right" label-width="100px" :inline="true">
            <el-row>
                <el-col :span="4">
                    <el-form-item label="客户编码" prop="clienteleNum">
                        <el-input v-model="clienteleForm.clienteleNum" placeholder="请输入客户编码" size="small" style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="客户名称" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入客户名称" clearable size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="客户类别" prop="deptId">
                        <treeselect v-model="form.deptId" :options="clienteleTypeOptions" :disable-branch-nodes="true" :show-count="true" style="width: 150px" placeholder="请选择客户类别" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="联系人" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入联系人" clearable size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="联系电话" prop="clienteleNum">
                        <el-input v-model="clienteleForm.clienteleNum" placeholder="请输入联系电话" clearable size="small" style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="手机" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入手机" clearable size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="4">
                    <el-form-item label="邮箱" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入邮箱" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="传真" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入传真" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="法人" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入法人" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="税号" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入税号" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="地址" prop="address">
                        <el-input v-model="clienteleForm.address" placeholder="请输入地址" size="small" style="width: 400px" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="4">
                    <el-form-item label="税率" prop="sl">
                        <el-input v-model="clienteleForm.sl" placeholder="请输入税率" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="税额" prop="address">
                        <el-input v-model="clienteleForm.address" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <el-form-item label="财务日期" prop="offerTime">
                        <el-date-picker v-model="clienteleForm.offerTime" placeholder="选择日期" size="small" clearable style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="收款条件" prop="paymentClause">
                        <el-input v-model="clienteleForm.address" size="small" :disabled="true" placeholder="其他应收款" style="width: 400px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="汇率" prop="fph">
                        <el-input v-model="clienteleForm.fph" style="width: 150px" size="small" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
        ...
        <div class="handle-box">
            <el-button type="primary" size="mini" icon="el-icon-paperclip" class="handle-del mr10" @click="handleAddLinkMateriel">产品</el-button>
        </div>
        <el-table v-loading="loading" :data="materielList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="产品编码" align="center" prop="clienteleId" />
            <el-table-column label="产品名称" align="center" prop="clienteleName" :show-overflow-tooltip="true" />
            <el-table-column label="规格" align="center" :show-overflow-tooltip="true" prop="type"></el-table-column>
            <el-table-column label="型号" align="center" :show-overflow-tooltip="true" prop="type"></el-table-column>
            <el-table-column label="所需扭矩" align="center" :show-overflow-tooltip="true" prop="sxnj"></el-table-column>
            <el-table-column label="输出扭矩" align="center" :show-overflow-tooltip="true" prop="sxnj"></el-table-column>
            ...
            <el-table-column label="数量" align="center" prop="bjNumber"></el-table-column>
            <el-table-column prop="je" label="金额" width="160" align="center">
                <template slot-scope="scope">
                    <span :v-model="scope.row.je">{{ (parseFloat(scope.row.price || 0) * parseInt(scope.row.bjNumber || 0)).toFixed(2) }}</span>
                </template>
            </el-table-column>
            <el-table-column prop="jsyq" label="技术要求" width="300" align="center"> </el-table-column>
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="300">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-upload" style="color:#e6a23c;" @click="handleUpload(scope.row)">图纸</el-button>
...
export default {
    ...
    created() {
        // this.clienteleForm.offerTime = new Date();
