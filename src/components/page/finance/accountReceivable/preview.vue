        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="收款账号"
                          prop="skzh">
              <el-input v-model="clienteleForm.skzh"
                        style="width: 400px"
                        size="small" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="付款账号"
                          prop="fkzh">
              <el-input v-model="clienteleForm.fkzh"
                        style="width: 400px"
                        size="small" />
            </el-form-item>
          </el-col>
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <el-button size="mini"
                     type="text"
                     icon="el-icon-info"
                     @click="handlePreview(scope.row)">订单明细</el-button>
          <el-button size="mini"
                     type="text"
                     icon="el-icon-info"
                     @click="handlePreview(scope.row)">收款明细</el-button>
        </template>
      </el-table-column>
    </el-table>
