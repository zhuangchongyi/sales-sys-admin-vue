<template>
    <div class="container">
        ...
        <div class="handle-box">
            <el-button type="primary" size="mini" icon="el-icon-paperclip" class="handle-del mr10" :disabled="true" @click="handleAddClientele">客户</el-button>
        </div>
            ...
            <el-row>
                <el-col :span="4">
                    <el-form-item label="客户编码" prop="clienteleNum">
                        <el-input v-model="clienteleForm.clienteleNum" placeholder="请输入客户编码" :disabled="true" size="small" style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="客户名称" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入客户名称" :disabled="true" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <el-form-item label="联系人" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入联系人" :disabled="true" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="联系电话" prop="clienteleNum">
                        <el-input v-model="clienteleForm.clienteleNum" placeholder="请输入联系电话" :disabled="true" size="small" style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="手机" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入手机" :disabled="true" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="4">
                    <el-form-item label="邮箱" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入邮箱" size="small" :disabled="true" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="传真" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入传真" size="small" :disabled="true" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="法人" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入法人" size="small" :disabled="true" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="税号" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" placeholder="请输入税号" size="small" :disabled="true" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="地址" prop="address">
                        <el-input v-model="clienteleForm.address" placeholder="请输入地址" size="small" :disabled="true" style="width: 400px" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="收款日期" prop="offerTime">
                        <el-date-picker v-model="clienteleForm.offerTime" placeholder="选择日期" size="small" :disabled="true" style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="收款账号" prop="fph">
                        <el-input v-model="clienteleForm.fph" style="width: 150px" :disabled="true" size="small" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="付款账号" prop="fph">
                        <el-input v-model="clienteleForm.fph" style="width: 150px" :disabled="true" size="small" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="clienteleForm.remark" type="textarea" :disabled="true" style="width: 1000px" size="small" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
      ...
      <el-table-column label="操作"
        ...
        <el-dialog :title="title" :visible.sync="linkMaterielOpen" width="800px" append-to-body>
            <el-form :model="materielQueryParams" ref="materielQueryParams" :inline="true">
                ...
                <el-form-item label="订单号" prop="materielName">
                    <el-input v-model="materielQueryParams.materielName" placeholder="请输入订单号" size="small" style="width: 180px" @keyup.enter.native="handleQueryMateriel" />
                </el-form-item>
                <el-form-item>
            ...
            <el-table v-loading="linkMaterielLoading" :data="linkMaterielListData" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="订单号" align="center" prop="materielId" width="80" />
