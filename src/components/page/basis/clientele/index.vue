<template>
  <div class="container">
      ...
      <el-col :span="20"
        ...
        <div class="handle-box">
          <el-button type="primary"
                     ...
                     v-hasPermi="['basis:clientele:add']"
        ...
        <el-table v-loading="loading"
          ...
          <el-table-column label="邮箱"
                           ...
                           prop="email"
                           width="150"></el-table-column>
          <el-table-column label="统一社会信用证号"
                           align="center"
                           prop="certificateNum"
                           width="150"></el-table-column>
          <el-table-column label="业务员名称"
                           align="center"
                           prop="personnel.nickname"
                           width="100"></el-table-column>
          <el-table-column label="部门名称"
                           align="center"
                           prop="personnel.dept.deptName"
                           width="100"></el-table-column>
          ...
          <el-table-column label="操作"
            ...
            <template slot-scope="scope">
              <el-button size="mini"
                         type="text"
                         icon="el-icon-edit"
                         v-hasPermi="['basis:clientele:edit']"
                         @click="handleUpdate(scope.row)">修改</el-button>
              <el-button size="mini"
                         type="text"
                         icon="el-icon-edit-outline"
                         style="color:#e6a23c;"
                         v-hasPermi="['basis:clienteleProduct:list']"
                         @click="handleAddMateriel(scope.row)">产品客户价</el-button>
              <el-button size="mini"
                         type="text"
                         style="color:#fd5656"
                         v-hasPermi="['basis:clientele:delete']"
                         icon="el-icon-delete"
      ...
      <el-form ref="form"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="客户编码"
                          prop="clienteleNum">
              <el-input v-model="form.clienteleNum"
                        placeholder="请输入客户编码" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="合作时间"
                          prop="corporationTime">
              <el-date-picker v-model="form.corporationTime"
                              style="width:200px;"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="业务员编码"
                          prop="userNum">
              <el-input v-model="form.personnel.userNum"
          ...
          <el-col :span="12">
            <el-form-item label="业务员名称"
                          prop="nickname">
              <el-input v-model="form.personnel.nickname"
          ...
          <el-col :span="12">
            <el-form-item label="部门编码"
                          prop="deptNum">
              <el-input v-model="form.personnel.dept.deptNum"
                        placeholder="请输入部门编码"
                        :disabled="true" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="部门名称"
                          prop="deptName">
              <el-input v-model="form.personnel.dept.deptName"
                        placeholder="请输入部门名称"
                        :disabled="true" />
            </el-form-item>
          </el-col>
    ...
    <el-dialog :title="title"
               ...
               width="550px"
               append-to-body>
      <el-form :model="personnelQuery"
               ref="personnelQuery"
               :inline="true">
        <el-form-item label="员工编码"
                      prop="userNum">
          <el-input v-model="personnelQuery.userNum"
                    placeholder="请输入编码 "
                    clearable
                    size="small"
                    style="width: 120px"
        ...
        <el-form-item label="员工名称"
                      prop="nickname">
          <el-input v-model="personnelQuery.nickname"
                    placeholder="请输入名称 "
                    clearable
                    size="small"
                    style="width: 120px"
...
export default {
  ...
  data () {
    return {
      ...
      levelOptions: [{ dictValue: '0', dictLabel: 'A客户' }, { dictValue: '1', dictLabel: 'B客户' }, { dictValue: '2', dictLabel: 'C客户' }, { dictValue: '3', dictLabel: 'D客户' }, { dictValue: '4', dictLabel: 'E客户' }],
  ...
  methods: {
    ...
    statusFormatter (row, column) {
      return this.selectDictLabel(this.statusOptions, row.userType);
    },
    // 查询客户列表
    getList () {
