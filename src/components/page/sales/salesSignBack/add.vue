      ...
      <el-row>
        ...
        <el-col :span="4">
          <el-form-item label="拒收总数"
                        prop="jszs">
            <el-input v-model="clienteleForm.jszs"
                      size="small"
                      :disabled="true"
                      style="width: 150px" />
          </el-form-item>
      ...
      <el-table-column prop="bcqss"
        ...
        <template slot-scope="scope">
          <el-input size="mini"
                    ...
                    maxLength='9'
                    v-model="scope.row.bcqss" />
        </template>
      </el-table-column>
      <el-table-column prop="bcjss"
                       label="本次拒收数"
                       width="120"
                       align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <!-- <el-button size="mini"
                     type="text"
                     icon="el-icon-edit"
                     @click="handleUpdateMateriel(scope.row)">编辑</el-button> -->
          <el-button size="mini"
                     type="text"
                     icon="el-icon-upload"
                     style="color:#e6a23c;"
    ...
    <el-dialog :title="title"
      ...
      <el-table v-loading="linkMaterielLoading"
        ...
        <el-table-column prop="jsyq"
                         ...
                         :show-overflow-tooltip="true"
                         align="center" />
        <el-table-column prop="cks"
                         label="出库数"
                         align="center" />
        <el-table-column prop="yqss"
                         label="已签收数"
                         align="center">
        </el-table-column>
        <el-table-column prop="wqss"
                         label="未签收数"
                         align="center">
        </el-table-column>
        <el-table-column prop="jss"
                         label="拒收数"
                         align="center">
        </el-table-column>
      </el-table>
...
export default {
  ...
  data () {
    return {
      ...
      materielSelection: [],
      // 支付类型数据字典
      warehouseOptions: [{ dictValue: '0', dictLabel: '仓库1' }, { dictValue: '1', dictLabel: '仓库2' }, { dictValue: '2', dictLabel: '仓库4' }, { dictValue: '3', dictLabel: '仓库4' }],
      //添加人员
