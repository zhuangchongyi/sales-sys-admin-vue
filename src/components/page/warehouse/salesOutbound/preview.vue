  ...
  <div class="container">
    <div v-show="isShow">
      ...
      <el-button icon="el-icon-close"
                 @click="clearAddForm">取消审核</el-button>
    </div>
      ...
      <el-row>
        <el-col :span="4">
          <el-form-item prop="warehouse"
                        label="仓库">
            <el-select v-model="clienteleForm.warehouse"
                       placeholder="选择仓库"
                       :disabled="true"
                       size="small"
                       style="width: 150px">
              <el-option v-for="dict in warehouseOptions"
                         :key="dict.dictValue"
