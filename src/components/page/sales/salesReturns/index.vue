...
export default {
  ...
  methods: {
    ...
    /** 新增按钮操作 */
    handleAdd () {
      this.$router.push('/page/sales/salesReturns/add');
    },
    /** 修改按钮操作 */
    handleUpdate (row) {
      this.$router.push({ name: '/page/sales/salesReturns/edit', params: { id: row.clienteleId } });
    },
    handlePreview (row) {
      this.$router.push({ name: '/page/sales/salesReturns/preview', params: { id: row.clienteleId, isShow: false } });
    },
    handleAudit (row) {
      this.$router.push({ name: '/page/sales/salesReturns/preview', params: { id: row.clienteleId, isShow: true, isAudit: true } });
    },
    handleSubmit () {
