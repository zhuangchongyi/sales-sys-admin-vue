    ...
    <div class="container">
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="退货日期" prop="returnsTime">
                        <el-date-picker v-model="supplierForm.returnsTime" style="width:155px;" readonly value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <el-form-item label="出库日期" prop="outboundTime">
                        <el-date-picker v-model="supplierForm.outboundTime" style="width:155px;" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择日期" readonly />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
        ...
        <el-form :model="formData" ref="formData" :rules="formRules">
            <el-table v-loading="loading" :data="formData.materielListData">
                ...
                <el-table-column prop="outboundNum" label="出库数量" align="center"> </el-table-column>
            </el-table>
        </el-form>
    </div>
</template>
...
<script>
import { auditPurchaseOutbound, getPurchaseOutbound, listPurchaseReturnsSub } from '@/api/purchase/returns.js';
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/purchase/outbound/preview' && this.supplierForm.returnsId !== this.$route.query.id) {
                this.getPurchaseReturnsData();
            }
        }
    },
    methods: {
        submitAuditForm() {
            ...
            let data = {
                id: this.supplierForm.returnsId,
                status: '3'
            };
            this.btnLoading = true;
            auditPurchaseOutbound(data)
                .then(res => {
                ...
                if (v) {
                    taht.$refs['supplierForm'].validate(valid => {
                        if (valid) {
                            ...
                            updatePurchaseReturns(data).then(res => {
                                if (res.success) {
