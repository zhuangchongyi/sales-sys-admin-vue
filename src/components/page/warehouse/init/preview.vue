<template>
    <div class="container">
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="number" label="现存量" width="120" align="center"> </el-table-column>
...
export default {
    ...
    created() {
        this.warehouseForm.warehouseId = this.$route.query.id;
        this.getInitData();
    },
    methods: {
        getInitData() {
            getInit(this.warehouseForm.warehouseId || 0).then(res => {
                this.warehouseForm.warehouseNum = res.data.warehouseNum;
                this.warehouseForm.warehouseName = res.data.warehouseName;
                this.loading = false;
