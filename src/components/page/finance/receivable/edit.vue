<template>
    <div class="container">
        <div>
            ...
            <el-button icon="el-icon-refresh" @click="getListData">重 置</el-button>
        </div>
...
<script>
import { addReceivable, getReceivable, listReceivableSub } from '@/api/finance/receivable.js';
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/finance/receivable/edit' && this.clienteleForm.receivableId !== this.$route.query.rid) {
                this.getListData();
            }
        }
    },
