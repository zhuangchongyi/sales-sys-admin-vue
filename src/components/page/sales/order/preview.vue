            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="客户编码" prop="clienteleNum">
                        <el-input v-model="clienteleForm.clienteleNum" maxlength="10" show-word-limit readonly size="small" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="客户名称" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" clearable readonly size="small" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <el-form-item label="联系人" prop="leader">
                        <el-input v-model="clienteleForm.leader" clearable readonly size="small" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="联系电话" prop="phone">
                        <el-input v-model="clienteleForm.phone" clearable size="small" readonly style="width: 155px;" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="4">
                    <el-form-item label="手机" prop="mobilephone">
                        <el-input v-model="clienteleForm.mobilephone" clearable size="small" readonly style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="邮箱" prop="email">
                        <el-input v-model="clienteleForm.email" size="small" readonly style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="法人" prop="legalPerson">
                        <el-input v-model="clienteleForm.legalPerson" size="small" readonly style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="社会信用号" prop="certificateNum">
                        <el-input v-model="clienteleForm.certificateNum" size="small" readonly style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="地址" prop="address">
                        <el-input v-model="clienteleForm.address" size="small" readonly style="width: 420px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <el-form-item label="交货日期" prop="deliveryTime">
                        <el-date-picker v-model="clienteleForm.deliveryTime" style="width:155px;" readonly value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="付款条件" prop="payCondition">
                        <el-input v-model="clienteleForm.payCondition" placeholder="请输入付款条件" readonly size="small" style="width: 420px" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="4">
                    <el-form-item label="订单日期" prop="orderTime">
                        <el-date-picker v-model="clienteleForm.orderTime" style="width:155px;" value-format="yyyy-MM-dd" readonly format="yyyy-MM-dd" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="业务员" prop="personnelName">
                        <el-input v-model="clienteleForm.personnelName" size="small" suffix-icon="el-icon-search" readonly ref="personnelBlur" style="width: 155px;" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="clienteleForm.remark" type="textarea" autosize readonly style="width: 1000px" size="small" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/sales/order/preview' && this.orderId !== to.query.id) {
    ...
    methods: {
        ...
        cancelAuditForm() {
            if (this.clienteleForm.status === '4' || this.clienteleForm.status === '6') {
                this.msgError('已反审核');
                return;
            }
            let data = {
