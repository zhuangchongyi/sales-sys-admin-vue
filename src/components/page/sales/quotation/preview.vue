  ...
  <div class="container">
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="所需扭矩"
                       ...
                       width="100"
                       :show-overflow-tooltip="true"
                       prop="needTorque"></el-table-column>
      <el-table-column label="输出扭矩"
                       align="center"
                       width="100"
                       :show-overflow-tooltip="true"
                       prop="outTorque"></el-table-column>
    ...
    <el-dialog :title="title"
      ...
      <el-form :model="clienteleQueryParams"
        ...
        <el-form-item label="客户类别"
                      prop="categoryId">
          <treeselect v-model="clienteleQueryParams.categoryId"
                      :options="clienteleTypeOptions"
                      :disable-branch-nodes="true"
                      :show-count="true"
                      style="width: 160px"
    ...
    <el-dialog :title="title"
      ...
      <el-table v-loading="linkMaterielLoading"
                ...
                highlight-current-row
                @row-dblclick="clickSelectionMateriel"
    ...
    <el-dialog :title="title"
      ...
      <div slot="footer"
           class="dialog-footer">
        <el-button type="primary"
                   @click="submitFormMateriel">确 定</el-button>
        <el-button @click="cancel">取 消</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog :title="title"
               ...
               width="550px"
               append-to-body>
      <el-form :model="personnelQueryParams"
               ref="personnelQueryParams"
               :inline="true">
        <el-form-item label="员工编码"
                      prop="userNum">
          <el-input v-model="personnelQueryParams.userNum"
                    placeholder="请输入编码 "
                    clearable
                    size="small"
                    style="width: 120px"
        ...
        <el-form-item label="员工名称"
                      prop="nickname">
          <el-input v-model="personnelQueryParams.nickname"
                    placeholder="请输入名称 "
                    clearable
                    size="small"
                    style="width: 120px"
        ...
        <el-form-item>
          <el-button type="primary"
                     icon="el-icon-search"
                     size="small"
                     @click="handlePersonnelQuery">搜索</el-button>
        </el-form-item>
      </el-form>
      <el-table v-loading="personnelLoading"
                :data="personnelListData"
                highlight-current-row
                @row-dblclick="submitFormPersonnel">
        <el-table-column label="选择"
                         width="60">
          <template slot-scope="scope">
            <el-radio :label="scope.$index+1"
                      v-model="radio"
                      @change.native="getPersonnelRow(scope.row)"></el-radio>
          </template>
        </el-table-column>
      ...
      <div class="pagination">
        <el-pagination background
                       ...
                       @current-change="handlePageChangePersonnel"></el-pagination>
      </div>
    </el-dialog>
    ...
    <el-dialog :title="title"
               ...
               width="550px"
               append-to-body>
      <el-form :model="unitsQueryParam"
               ref="unitsQueryParam"
               :inline="true">
        <el-form-item label="单位类型"
                      prop="unitsType">
          <el-select v-model="unitsQueryParam.unitsType"
                     clearable
                     size="small"
                     style="width: 120px">
        ...
        <el-form-item label="编码"
                      prop="unitsNum">
          <el-input v-model="unitsQueryParam.unitsNum"
                    clearable
                    size="small"
                    style="width: 100px"
                    @keyup.enter.native="handleQueryUnits" />
        </el-form-item>
        <el-form-item label="名称"
                      prop="unitsName">
          <el-input v-model="unitsQueryParam.unitsName"
                    clearable
                    size="small"
                    style="width: 100px"
                    @keyup.enter.native="handleQueryUnits" />
        ...
        <el-form-item>
          <el-button type="primary"
                     icon="el-icon-search"
                     size="small"
                     @click="handleQueryUnits">搜索</el-button>
        </el-form-item>
      </el-form>
      <el-table v-loading="unitsLoading"
                :data="unitsListData"
                highlight-current-row
                @row-dblclick="handleClickUnits">
        <el-table-column label="选择"
                         width="60">
          <template slot-scope="scope">
            <el-radio :label="scope.$index+1"
                      v-model="radio"
                      @change.native="getUnitsRow(scope.row)"></el-radio>
          </template>
        </el-table-column>
      ...
      <div class="pagination">
        <el-pagination background
                       ...
                       @current-change="handlePageChangeUnits"></el-pagination>
      </div>
    </el-dialog>
  </div>
</template>
