  ...
  <div>
    <div class="container">
      ...
      <el-table :data="tableData"
        ...
        <el-table-column prop="clientelePhone"
                         ...
                         :show-overflow-tooltip="true"
                         align="center" />
        <el-table-column prop="clientelePrice"
                         label="欠款"
                         :show-overflow-tooltip="true"
                         align="center" />
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text"
                       ...
                       @click="handleCollection(scope.row)">收款</el-button>
            <el-button type="text"
                       icon="el-icon-info"
    ...
    <el-dialog :title="title"
          ...
          <el-col :span="4">
            <el-form-item>
              <el-button type="primary"
                         ...
                         size="mini"
                         @click="handleQueryWarehouse">刷新</el-button>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
              ...
              <el-table-column label="操作"
                ...
                <template slot-scope="scope">
                  <el-button type="text"
                             icon="el-icon-delete"
                             style="color:#fd5656"
                             @click="handleDeleteHedge(scope.$index)">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-col>
      ...
      <div slot="footer"
           class="dialog-footer">
        <el-button type="primary"
                   @click="selectionForm">确 定</el-button>
        <el-button type="primary"
