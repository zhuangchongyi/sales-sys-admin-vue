        ...
        <div class="container">
            <el-form :model="queryParams" ref="queryParams" :inline="true">
                <el-form-item label="" prop="unitsNum">
                    <el-input v-model="queryParams.unitsNum" placeholder="单位编码" clearable size="small" style="width: 200px" @keyup.enter.native="handleQuery" />
                </el-form-item>
                <el-form-item label="" prop="unitsName">
                    <el-input v-model="queryParams.unitsName" placeholder="单位名称" clearable size="small" style="width: 200px" @keyup.enter.native="handleQuery" />
                </el-form-item>
                <el-form-item label="" prop="unitsType">
                    <el-select v-model="queryParams.unitsType" placeholder="单位类型" clearable size="small" style="width: 200px">
            ...
            <div class="handle-box">
                <el-button type="primary" size="small" icon="el-icon-plus" class="handle-del mr10" v-hasPermi="['basis:units:add']" @click="handleAdd">新增</el-button>
            </div>
            <el-table v-loading="loading" :data="unitsListData" class="table" ref="unitsListData" header-cell-class-name="table-header">
                <el-table-column type="selection" width="55" align="center"></el-table-column>
                <el-table-column prop="unitsNum" label="单位编码" align="center"></el-table-column>
                <el-table-column prop="unitsName" label="单位名称" align="center"></el-table-column>
                <el-table-column label="单位类型" prop="status" :formatter="unitsTypeFormatter" align="center"> </el-table-column>
                ...
                <el-table-column label="操作" width="300" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-edit" v-hasPermi="['basis:units:edit']" @click="handleUpdate(scope.row)">修改</el-button>
                        <el-button type="text" icon="el-icon-delete" style="color:#fd5656" v-hasPermi="['basis:units:delete']" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="单位类型" prop="unitsType">
                    <el-radio-group v-model="form.unitsType">
                        <el-radio v-for="dict in unitsTypeOptions" :key="dict.dictValue" :label="dict.dictValue">{{ dict.dictLabel }}</el-radio>
                    </el-radio-group>
                </el-form-item>
