  ...
  <div class="container">
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="售价"
                       align="center"
                       prop="clientelePrice"></el-table-column>
      ...
      <el-table-column label="金额"
                       ...
                       prop="je">
        <template slot-scope="scope">
          <span :v-model="scope.row.je">{{(parseInt(scope.row.ths||0)*parseFloat(scope.row.clientelePrice||0)).toFixed(2)}}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title"
      ...
      <el-table v-loading="linkMaterielLoading"
        ...
        <!-- <el-table-column prop="warehouse"
                         ...
                         align="center">
          <template slot-scope="scope">
            <el-select v-model="scope.row.warehouse"
                       placeholder="选择仓库"
                       clearable
                       size="small"
                       style="width: 160px">
