    ...
    <div class="container">
      ...
      <el-button type="primary"
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="realityNum" label="实盘数" width="120" align="center">
                <template slot-scope="scope">
                    <el-input size="mini" oninput="value=value.replace(/[^\d]/g,'')" maxLength="9" @input="calculateNumber(scope.row)" v-model="scope.row.realityNum" />
                </template>
            </el-table-column>
