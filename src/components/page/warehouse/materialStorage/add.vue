  ...
  <div class="container">
      ...
      <el-row>
        ...
        <el-col :span="4">
          <el-form-item label="来源类型"
                        prop="ly">
            <el-select v-model="clienteleForm.ly"
                       placeholder="请选择来源类型"
                       clearable
                       style="width: 150px"
                       size="small">
              <el-option v-for="dict in sourceOptions"
                         :key="dict.dictValue"
        ...
        <el-col :span="4">
          <el-form-item label="供应单位"
                        prop="gydw">
            <el-input v-model="clienteleForm.gydw"
                      placeholder="请输入供应单位"
                      size="small"
                      style="width: 150px" />
          </el-form-item>
        ...
        <el-col :span="4">
          <el-form-item label="入库时间"
                        prop="time">
            <el-date-picker v-model="clienteleForm.time"
                            placeholder="请选择"
                            size="small"
                            type="date"
                            style="width: 150px" />
        ...
        <el-col :span="4">
          <el-form-item label="合计金额"
                        prop="je">
            <el-input v-model="clienteleForm.je"
                      size="small"
                      :disabled="true"
                      style="width: 150px" />
          </el-form-item>
    ...
    <el-table :data="materielList"
      ...
      <el-table-column prop="je"
                       ...
                       align="center">
        <template slot-scope="scope">
          <span :v-model="scope.row.je">{{(parseInt(scope.row.rksl||0)*parseFloat(scope.row.dj||0)).toFixed(2)}}</span>
        </template>
      </el-table-column>
...
export default {
  ...
  data () {
    return {
      ...
      materielSelection: [],
      // 来源类型数据字典
      sourceOptions: [{ dictValue: '0', dictLabel: '进口' }, { dictValue: '1', dictLabel: '生产' }, { dictValue: '2', dictLabel: '采购' }, { dictValue: '3', dictLabel: '其他' }],
      //添加人员
