    ...
    <div class="container">
      ...
      <el-table :data="tableData"
        ...
        <el-table-column prop="createTime"
                         label="报废日期"
                         align="center" />
        <el-table-column prop="createPrice"
                         label="报废金额"
                         align="center" />
        <el-table-column prop="createTime"
                         label="录单人"
...
export default {
  ...
  methods: {
    ...
    handleUpdate (index, row) {
      this.$router.push({ name: '/page/warehouse/scrap/edit', params: { id: row.id } });
    },
    handleAudit (row) {
      this.$router.push({ name: '/page/warehouse/scrap/preview', params: { id: row.id, isShow: true } });
    },
    /** 查看按钮操作 */
    handleExamine (index, row) {
      this.$router.push({ name: '/page/warehouse/scrap/preview', params: { id: row.id, isShow: false } });
    },
    handleDelete () {
