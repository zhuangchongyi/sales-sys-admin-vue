<template>
    <div class="container">
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="调整时间" prop="adjustmentTime">
                        <el-date-picker v-model="warehouseForm.adjustmentTime" readonly placeholder="请选择日期" size="small" value-format="yyyy-MM-dd" format="yyyy-MM-dd" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="warehouseForm.remark" readonly type="textarea" style="width: 1000px" size="small" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="number" label="调整数量" align="center"> </el-table-column>
            <el-table-column prop="totalPrice" label="调整金额" align="center"> </el-table-column>
            <el-table-column prop="remark" label="调整原因" width="300" align="center"> </el-table-column>
        </el-table>
...
import { getAdjustment, addAndUpdateAdjustment, listAdjustmentSub, auditAdjustment } from '@/api/warehouse/adjustment.js';
...
export default {
    ...
    watch: {
        $router(to, form) {
            if (to.path === '/page/warehouse/adjustment/preview' && this.warehouseForm.adjustmentId !== to.query.id) {
    ...
    methods: {
        submitAuditForm() {
            ...
            let data = {
                adjustmentId: this.warehouseForm.adjustmentId,
                status: '3'
            };
            this.btnLoading = true;
            auditAdjustment(data)
                .then(res => {
