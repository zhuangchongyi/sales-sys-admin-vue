            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="clienteleForm.remark" type="textarea" maxlength="250" style="width: 1000px" size="small" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
...
<script>
import { addQuotation, getQuotation } from '@/api/sales/quotation.js';
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/sales/quotation/edit' && this.quotationId !== to.query.id) {
