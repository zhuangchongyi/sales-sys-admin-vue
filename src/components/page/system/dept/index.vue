    ...
    <div>
        <div class="container">
            ...
            <div class="handle-box">
                <el-button class="filter-item" type="primary" icon="el-icon-plus" size="small" v-hasPermi="['system:dept:add']" @click="handleAdd">新增</el-button>
            </div>
            <el-table v-loading="loading" :data="deptListData" row-key="deptId" default-expand-all :tree-props="{ children: 'children', hasChildren: 'hasChildren' }">
                ...
                <el-table-column label="创建人" align="center" prop="createBy" width="200"></el-table-column>
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini" type="text" icon="el-icon-plus" v-hasPermi="['system:dept:add']" @click="handleAdd(scope.row)">新增</el-button>
                        <el-button v-if="scope.row.deptType == 0" size="mini" type="text" icon="el-icon-info" v-hasPermi="['system:dept:user']" @click="handlePersonnel(scope.row)">人员</el-button>
                        <el-button
            ...
            <!-- 人员弹窗 -->
            <el-dialog :title="title" :visible.sync="openPersonnel" width="600px" append-to-body>
                <el-table :data="personnelList">
                    ...
                    <el-table-column label="性别" align="center" :formatter="genderFormatter" prop="gender" />
...
export default {
    ...
    data() {
        return {
            ...
            deptTypeOptions: [
                { dictValue: '0', dictLabel: '部门' },
                { dictValue: '1', dictLabel: '公司' }
            ],
            // 查询参数
            queryDeptParams: {
                deptName: undefined,
    ...
    methods: {
        genderFormatter(row, column) {
            return this.getGenderFormatter(row.gender);
        },
        // 部门列表
        getList() {
