            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="退货日期" prop="returnsTime">
                        <el-date-picker v-model="clienteleForm.returnsTime" placeholder="选择日期" size="small" style="width: 150px;" readonly />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="退货人员" prop="personnelName">
                        <el-input v-model="clienteleForm.personnelName" size="small" placeholder="选择人员" style="width: 155px;" readonly />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/sales/returns/preview' && this.clienteleForm.returnsId !== this.$route.query.rId) {
    ...
    methods: {
        submitAuditForm() {
            ...
            let data = {
                returnsId: this.clienteleForm.returnsId,
                status: '3'
            };
        ...
        calculateTotal(row) {
            // 最大可退货数量= 订购数量-已签收数量
            let returnsNum = parseInt(row.number || 0) - parseInt(row.hasSignbackNum || 0) - parseInt(row.hasReturnNum || 0);
            if (row.returnsNum > returnsNum) {
