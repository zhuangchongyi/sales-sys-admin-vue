            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="发货日期" prop="shipmentsTime">
                        <el-date-picker v-model="clienteleForm.shipmentsTime" readonly style="width:155px;" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
