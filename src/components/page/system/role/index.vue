<template>
  <div>
    <div class="container">
      <el-form :model="queryRoleParams"
               ref="queryRoleParams"
               :inline="true">
        <el-form-item label="角色编码"
                      prop="roleNum">
          <el-input v-model="queryRoleParams.roleNum"
                    placeholder="请输入角色编码"
                    clearable
                    size="small"
                    style="width: 200px"
        ...
        <el-form-item label="角色名称"
                      prop="roleName">
          <el-input v-model="queryRoleParams.roleName"
                    placeholder="请输入角色名称"
                    clearable
                    size="small"
                    style="width: 200px"
        ...
        <el-form-item label="状态"
                      prop="status">
          <el-select v-model="queryRoleParams.status"
                     placeholder="角色状态"
                     clearable
                     size="small"
                     style="width: 200px">
      ...
      <el-table v-loading="loading"
        ...
        <el-table-column prop="status"
                         label="状态"
                         width="100"
                         :formatter="startStatusFormatter"></el-table-column>
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text"
                       ...
                       style="color:#67c23a"
                       v-hasPermi="['system:role:permission']"
                       @click="handleMenu(scope.row)">菜单权限</el-button>
            <!-- <el-button
                            type="text"
                            icon="el-icon-circle-check"
                            style="color:#e6a23c"
            ...
            <el-button type="text"
                       icon="el-icon-s-data"
                       style="color:#e6a23c"
                       v-hasPermi="['system:role:user']"
                       @click="handleLookUser(scope.row)">查看用户</el-button>
            <el-button type="text"
                       icon="el-icon-delete"
                       style="color:#fd5656"
                       v-hasPermi="['system:role:detele']"
    ...
    <el-dialog :title="title"
      ...
      <div slot="footer"
           class="dialog-footer">
        <el-button type="primary"
                   @click="submitFormMenu">确 定</el-button>
        <el-button @click="cancel">取 消</el-button>
      </div>
    </el-dialog>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        roleNum: [{ required: true, message: '角色编码不能为空', trigger: 'blur' }, { max: 10, message: '长度不能超过10个字符', trigger: 'blur' }
        ]
      },
      //表单参数
      title: '',
