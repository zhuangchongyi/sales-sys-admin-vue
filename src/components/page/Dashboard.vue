        ...
        <el-row :gutter="20">
            <el-col :span="8">
                ...
                <el-card shadow="hover" style="height:252px;">
                    ...
                    磁盘
                    <el-progress :percentage="46.9" color="#f56c6c" />
                </el-card>
            </el-col>
            <el-col :span="16">
                ...
                <el-card shadow="hover" style="height:430px;">
                    <div slot="header" class="clearfix">
                        <span>待办事项</span>
                        <el-button style="float: right; padding: 3px 0" type="text" @click="addSchedule">添加</el-button>
                    </div>
                    <el-table :show-header="false" :data="todoList" height="330px" style="width:100%;">
                        <el-table-column width="40">
                            <template slot-scope="scope">
                                <el-checkbox v-model="scope.row.status" @change="editStatus(scope.$index, scope.row)"></el-checkbox>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column width="60">
                            <template slot-scope="scope">
                                <el-button size="mini" type="text" icon="el-icon-edit" @click="editSchedule(scope.$index, scope.row)"></el-button>
                                <el-button size="mini" type="text" icon="el-icon-delete" style="color:#fd5656" @click="deleteSchedule(scope.$index, scope.row)"></el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-card>
