<template>
    <div class="container">
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="报废时间" prop="scrapTime">
                        <el-date-picker v-model="warehouseForm.scrapTime" readonly placeholder="请选择日期" size="small" value-format="yyyy-MM-dd" format="yyyy-MM-dd" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <el-form-item label="报废金额" prop="totalPrice">
                        <el-input v-model="warehouseForm.totalPrice" size="small" readonly style="width: 150px" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="scrapNum" label="报废数" align="center"> </el-table-column>
            <el-table-column prop="totalPrice" label="报废金额" align="center"> </el-table-column>
            <el-table-column prop="remark" label="报废原因" width="300" align="center"> </el-table-column>
        </el-table>
...
import { getScrap, addAndUpdateScrap, listScrapSub, auditScrap } from '@/api/warehouse/scrap.js';
...
export default {
    ...
    watch: {
        $router(to, form) {
            if (to.path === '/page/warehouse/scrap/preview' && this.warehouseForm.scrapId !== to.query.id) {
    ...
    methods: {
        submitAuditForm() {
            ...
            let data = {
                scrapId: this.warehouseForm.scrapId,
                status: '3'
            };
