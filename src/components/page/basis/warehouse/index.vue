    ...
    <div class="container">
      ...
      <div class="handle-box">
        <el-button type="primary"
                   ...
                   v-hasPermi="['basis:warehouse:add']"
                   @click=" handleAdd">新增</el-button>
      </div>
      <el-table v-loading="loading"
                :data="warehouseListData"
                class="table"
                ref="warehouseListData"
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            <el-button type="text"
                       icon="el-icon-edit"
                       v-hasPermi="['basis:warehouse:edit']"
                       @click=" handleUpdate(scope.row)">修改</el-button>
            <el-button type="text"
                       icon="el-icon-delete"
                       style="color:#fd5656"
                       v-hasPermi="['basis:warehouse:delete']"
  ...
  data () {
    return {
      ...
      rules: {
        ...
        warehouseNum: [{ required: true, message: '仓库编码不能为空', trigger: 'blur' }, { max: 10, message: '长度不能超过10个字符', trigger: 'blur' }],
      }
    };
  },
  created () {
