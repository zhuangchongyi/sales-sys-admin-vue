    ...
    <el-dialog :title="title"
      ...
      <el-form :model="query"
        ...
        <el-form-item label="人员编码"
                      prop="clienteleNum">
          <el-input v-model="query.clienteleNum"
      ...
      <el-table :data="clienteleListData"
                @selection-change="handleSelectionChangePersonnel">
      ...
      <div slot="footer"
           class="dialog-footer">
        <el-button type="primary"
                   @click="submitFormPersonnel">确 定</el-button>
