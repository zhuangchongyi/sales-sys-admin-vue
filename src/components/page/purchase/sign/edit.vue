    ...
    <div class="container">
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right">
                <template slot-scope="scope">
                    <!-- <el-button size="small" type="text" icon="el-icon-upload" style="color:#e6a23c;" v-show="scope.row.orderSubId" @click="handleUpload(scope.row)">图纸</el-button> -->
...
<script>
import { updatePurchaseOrder, getPurchaseOrder, listPurchaseOrderSub } from '@/api/purchase/order.js';
...
export default {
    ...
    methods: {
        ...
        submitFormUnits(row) {
            this.form.unitsId = row.unitsId;
            this.form.unitsNum = row.unitsNum;
            this.form.unitsName = row.unitsName;
