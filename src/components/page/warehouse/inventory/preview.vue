<template>
    <div class="container">
      ...
      <el-button type="primary"
                 ...
                 @click="warehouseListDialog">仓库</el-button>
    </div> -->
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="盘点时间" prop="inventoryTime">
                        <el-date-picker v-model="warehouseForm.inventoryTime" readonly placeholder="请选择日期" size="small" value-format="yyyy-MM-dd" format="yyyy-MM-dd" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="warehouseForm.remark" type="textarea" readonly style="width: 1000px" size="small" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="realityNum" label="实盘数" width="120" align="center"> </el-table-column>
            <el-table-column prop="differenceNum" label="差异数" width="120" align="center"> </el-table-column>
        </el-table>
...
import { getInventory, addAndUpdateInventory, listInventorySub, auditInventory } from '@/api/warehouse/inventory.js';
...
export default {
    ...
    methods: {
        submitAuditForm() {
            ...
            let data = {
                inventoryId: this.warehouseForm.inventoryId,
                status: '3'
            };
        ...
        calculateAllNumber() {
            this.materielListData.forEach(item => {
                item.differenceNum = parseInt(item.realityNum || 0) - parseInt(item.number || 0);
            });
        },
        submitForm() {
