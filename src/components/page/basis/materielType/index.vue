<template>
    <div>
        <div class="container">
            <el-form :inline="true">
                <el-form-item label="">
                    <el-input v-model="queryParams.categoryName" placeholder="产品类别名称" clearable size="small" @keyup.enter.native="handleQuery" />
                </el-form-item>
                <el-form-item label="">
                    <el-input v-model="queryParams.categoryNum" placeholder="产品类别编码" clearable size="small" @keyup.enter.native="handleQuery" />
                </el-form-item>
                <el-form-item label="">
                    <el-select v-model="queryParams.status" placeholder="产品类别状态" clearable size="small">
            ...
            <div class="handle-box">
                <el-button class="filter-item" type="primary" icon="el-icon-plus" size="small" v-hasPermi="['basis:materielType:add']" @click="handleAdd">新增</el-button>
            </div>
            <el-table style="width: 100%" v-loading="loading" :data="categoryListData" row-key="categoryId" default-expand-all :tree-props="{ children: 'children', hasChildren: 'hasChildren' }">
                <el-table-column prop="categoryNum" label="产品类别编码" width="200"></el-table-column>
                <el-table-column prop="categoryName" label="产品类别名称" width="260"></el-table-column>
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                        <el-button size="mini" type="text" icon="el-icon-edit" v-hasPermi="['basis:materielType:edit']" @click="handleUpdate(scope.row)">修改</el-button>
                        <el-button size="mini" type="text" icon="el-icon-plus" v-hasPermi="['basis:materielType:add']" @click="handleAdd(scope.row)">新增</el-button>
                        <el-button
                    ...
                    <el-row>
                        <el-col :span="24" v-if="form.parentId !== 0">
                            <el-form-item label="上级类别" prop="parentId">
                                <treeselect v-model="form.parentId" :options="categoryOptions" :normalizer="normalizer" placeholder="选择上级产品类别" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <el-form-item label="类别名称" prop="categoryName">
                                <el-input v-model="form.categoryName" placeholder="请输入产品类别名称" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
