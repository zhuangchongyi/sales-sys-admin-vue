<template>
    <div class="container">
        <div>
            ...
            <el-button icon="el-icon-refresh" @click="getReceiptData">重 置</el-button>
        </div>
...
<script>
import { updateReceipt, getReceipt } from '@/api/finance/receipt.js';
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/finance/receipt/edit' && this.clienteleForm.receiptId !== this.$route.query.rid) {
                this.getReceiptData();
            }
        }
    },
