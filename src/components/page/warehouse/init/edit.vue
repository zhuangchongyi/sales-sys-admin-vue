      ...
      <el-row>
        <el-col :span="4">
          <el-form-item label="仓库编码"
                        prop="clienteleNum">
            <el-input v-model="warehouseForm.clienteleNum"
                      placeholder="请输入仓库编码"
                      size="small"
                      style="width: 150px;" />
          </el-form-item>
        ...
        <el-col :span="4">
          <el-form-item label="仓库名称"
                        prop="clienteleName">
            <el-input v-model="warehouseForm.clienteleName"
                      size="small"
                      style="width: 150px" />
          </el-form-item>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    submitWarehouseForm () {
      this.warehouseForm = this.warehouseSelected;
    ...
    submitFormPersonnel () {
      ...
      this.personnelOpen = false;
      this.warehouseForm = this.personnelSelection[0];
