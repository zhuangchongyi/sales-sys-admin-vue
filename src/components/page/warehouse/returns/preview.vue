<template>
    <div class="container">
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="退入仓库" prop="warehouseName">
                        <el-input v-model="clienteleForm.warehouseName" size="small" placeholder="请选择" style="width: 150px" readonly />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="入库日期" prop="storageTime">
                        <el-date-picker v-model="clienteleForm.storageTime" placeholder="选择日期" size="small" style="width: 150px;" readonly />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="入库人员" prop="storageBy">
                        <el-input v-model="clienteleForm.storageBy" size="small" placeholder="请选择" style="width: 155px;" readonly />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="realityNum" label="入库数量" align="center"></el-table-column>
        </el-table>
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/sales/returns/edit') {
    ...
    methods: {
        submitAuditForm() {
            if (this.clienteleForm.auditStatus === '3') {
                this.msgError('已审核');
                return;
            }
            let data = {
