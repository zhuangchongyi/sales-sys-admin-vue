<template>
    <div class="container">
        <div>
            ...
            <el-button icon="el-icon-close" @click="getPurchaseReturnsData">重 置</el-button>
        </div>
...
import { updatePurchaseReturns, getPurchaseReturns, listPurchaseReturnsSub } from '@/api/purchase/returns.js';
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/purchase/returns/edit' && this.supplierForm.returnsId !== this.$route.query.id) {
                this.getPurchaseReturnsData();
            }
        }
    },
