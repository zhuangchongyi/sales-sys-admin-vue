            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="供应单位" prop="sourceCompany">
                        <el-input v-model="warehouseForm.sourceCompany" placeholder="请输入供应单位" size="small" style="width: 150px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
...
export default {
    ...
    methods: {
        ...
        submitWarehouseForm(row) {
            ...
            this.$set(this.warehouseForm, 'storageTime', this.parseTime(new Date()));
            this.open = false;
            this.isShow = true;
        },
        ...
        calculateTotalPrice(row) {
            row.totalPrice = (parseFloat(row.price || 0) * parseInt(row.number || 0)).toFixed(2);
        },
        submitMaterielForm() {
