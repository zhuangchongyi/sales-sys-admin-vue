    ...
    <div class="container">
        ...
        <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
            <el-form :model="clienteleQueryParams" ref="clienteleQueryParams" :inline="true">
                ...
                <el-form-item label="订单号" prop="orderNum">
                    <el-input v-model="clienteleQueryParams.orderNum" placeholder="订单号" clearable size="small" style="width: 155px;" @keyup.enter.native="handleQueryClientele" /> </el-form-item
...
export default {
    ...
    methods: {
        ...
        handleQueryClientele() {
            ...
            this.clienteleQueryParams.status = '3';
            listOrderPage(this.clienteleQueryParams).then(res => {
