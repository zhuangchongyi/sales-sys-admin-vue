<template>
  <div class="container">
    ...
    <el-row>
      <el-col :span="13">
        <el-table :data="form.materielListData">
          ...
          <el-table-column prop="sl"
                           label="数量"
                           align="center"></el-table-column>
          <el-table-column label="已发数"
                           align="center"
                           prop="fhNumber"></el-table-column>
          <el-table-column label="未发数"
                           align="center"
                           prop="fhNumber"></el-table-column>
          <el-table-column label="签收数"
                           align="center"
                           prop="qsNumber"></el-table-column>
          <el-table-column label="退回数"
                           align="center"
                           prop="qsNumber"></el-table-column>
        </el-table>
      </el-col>
      ...
      <el-col :span="10">
        <el-table :data="form.proceedsListData">
