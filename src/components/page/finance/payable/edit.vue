            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="退货单号" prop="returnsNum">
                        <el-input v-model="clienteleForm.returnsNum" size="small" style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="退货日期" prop="returnsTime">
                        <el-date-picker v-model="clienteleForm.returnsTime" size="small" style="width: 150px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
...
import { addPayable } from '@/api/finance/payable.js';
    ...
    data() {
        return {
            ...
            rules: {
                ...
                totalPrice: [{ required: true, message: '应付金额不能为空', trigger: 'blur' }]
            },
            //表单参数
            clienteleForm: {}, //主表信息
    ...
    methods: {
        ...
        submitAddForm() {
            this.$refs.clienteleForm.validate(valid => {
                if (valid) {
                    if (this.clienteleForm.payableNum) {
                        this.msgError('已保存');
                        return;
                    }
