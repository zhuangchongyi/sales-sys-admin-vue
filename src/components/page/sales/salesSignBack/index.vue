  ...
  <div class="container">
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column prop="clientelePhone"
                       label="拒收处理方式"
                       align="center"
                       :formatter='rejectionTypeFormatter'
                       width="120" />
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <el-button size="mini"
                     type="text"
                     icon="el-icon-edit"
                     @click="handleUpdate(scope.row)">签收</el-button>
          <el-button size="mini"
                     type="text"
                     icon="el-icon-info"
...
export default {
  ...
  methods: {
    ...
    /** 新增按钮操作 */
    handleAdd () {
      this.$router.push('/page/sales/salesSignBack/add');
    },
    /** 修改按钮操作 */
    handleUpdate (row) {
      this.$router.push({ name: '/page/sales/salesSignBack/edit', params: { id: row.clienteleId } });
    },
    handlePreview (row) {
      this.$router.push({ name: '/page/sales/salesSignBack/preview', params: { id: row.clienteleId, isShow: false } });
    },
    handleAudit (row) {
      this.$router.push({ name: '/page/sales/salesSignBack/preview', params: { id: row.clienteleId, isShow: true, isAudit: true } });
    },
    handleSubmit () {
