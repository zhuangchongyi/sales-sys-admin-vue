<template>
    <div class="container">
        ...
        <el-table v-loading="loading" :data="clienteleList" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="personnelName" label="业务员" align="center" width="100"></el-table-column>
            <el-table-column prop="deptName" label="部门" align="center" width="100"></el-table-column>
            <el-table-column label="金额" align="center" prop="price" width="160"></el-table-column>
            <el-table-column label="付款条件" align="center" prop="payType" width="160"></el-table-column>
            <el-table-column label="交易时间" align="center" prop="createTime" width="160"></el-table-column>
            <el-table-column label="创建时间" align="center" prop="createTime" width="160"></el-table-column>
            <el-table-column label="操作" align="center" width="180" class-name="small-padding fixed-width" fixed="right">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-info" @click="handleUpdate(scope.row)">查看</el-button>
                    <!-- <el-button size="mini"
                     type="text"
                     icon="el-icon-delete"
        ...
        <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="单价" prop="email">
