<template>
    <div class="container">
        ...
        <div class="handle-box">
            ...
            <el-dropdown trigger="click" style="margin: 0 10px;" v-hasPermi="['sales:shipments:submit']">
            ...
            <el-button type="primary" size="small" icon="el-icon-edit" class="handle-del mr10" :disabled="single" @click="handleAudit" v-hasPermi="['sales:shipments:audit']">审核</el-button>
            <el-button type="warning" size="small" icon="el-icon-edit" class="handle-del mr10" :disabled="single" @click="handleApprove" v-hasPermi="['sales:shipments:approve']">特批</el-button>
            <el-button type="primary" size="small" icon="el-icon-printer" class="handle-del mr10" @click="handlePrint" :disabled="single" v-hasPermi="['sales:shipments:print']">打印</el-button>
        </div>
