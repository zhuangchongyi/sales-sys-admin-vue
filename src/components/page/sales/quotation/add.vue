<template>
    <div class="container">
            ...
            <el-row>
                <el-col :span="4">
                    <el-form-item label="报价单号" prop="quotationNum">
                        <el-input v-model="quotationNum" size="small" readonly style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item label="报价日期" prop="quotationTime">
                        <el-date-picker v-model="clienteleForm.quotationTime" style="width:155px;" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="过期时间" prop="effectiveTime">
                        <el-date-picker v-model="clienteleForm.effectiveTime" style="width:155px;" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="clienteleForm.remark" type="textarea" style="width: 1000px" size="small" maxlength="250" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <div class="handle-box">
            <el-button type="primary" size="small" icon="el-icon-plus" class="handle-del mr10" @click="handleAddMateriel">新增产品</el-button>
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column label="产品编码" align="center" :show-overflow-tooltip="true" width="100" prop="materielNum" />
            <el-table-column label="产品名称" align="center" prop="materielName" width="150" :show-overflow-tooltip="true" />
            ...
            <el-table-column label="单位" prop="unitsName" width="100" align="center"></el-table-column>
            <el-table-column label="单价" prop="price" width="150" align="center">
        ...
        <el-dialog :title="title" :visible.sync="personnelOpen" width="600px" append-to-body>
            ...
            <el-table v-loading="personnelLoading" :data="personnelListData" highlight-current-row @row-dblclick="submitFormPersonnel">
                ...
                <el-table-column label="员工编码" align="center" prop="userNum" :show-overflow-tooltip="true" />
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                effectiveTime: [{ required: true, message: '过期时间不能为空', trigger: 'blur' }],
            ...
            formRules: {
                materielNum: [{ required: true, message: '产品编码不能为空', trigger: 'blur' }],
    ...
    methods: {
        ...
        getMaterielList() {
            ...
            listClienteleMateriel(this.materielQueryParams).then(res => {
