  ...
  <div class="container">
    <div v-show="isShow">
      <el-button type="primary"
                 icon="el-icon-check"
                 v-show="isAudit"
                 @click="submitAddForm">审核</el-button>
      <el-button type="primary"
                 icon="el-icon-close"
                 v-show="isAudit"
                 @click="submitAddForm">取消审核</el-button>
    </div>
    ...
    <el-form :model="clienteleForm"
      ...
      <el-row>
        <el-col :span="4">
          <el-form-item label="签收总数"
                        prop="sl">
            <el-input v-model="clienteleForm.sl"
                      size="small"
                      :disabled="true"
                      style="width: 150px" />
          </el-form-item>
        ...
        <el-col :span="4">
          <el-form-item label="签收日期"
                        prop="offerTime">
            <el-date-picker v-model="clienteleForm.offerTime"
                            placeholder="选择日期"
                            size="small"
                            :disabled="true"
                            style="width: 150px;" />
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="技术要求"
                       align="center"
                       :show-overflow-tooltip="true"
                       prop="jsyq"></el-table-column>
      <el-table-column label="出库数"
                       align="center"
                       prop="bjNumber"></el-table-column>
      <!-- <el-table-column label="已签收数"
                       align="center"
                       prop="bjNumber"></el-table-column>
      <el-table-column label="未签收数"
                       align="center"
                       prop="bjNumber"></el-table-column>
      <el-table-column label="拒收数"
                       align="center"
                       prop="warehouse"></el-table-column> -->
      <el-table-column label="签收数"
                       align="center"
                       width="120"
                       prop="warehouse"></el-table-column>
      <el-table-column label="拒收数"
                       ...
                       width="120"
                       prop="warehouse"></el-table-column>
      <el-table-column label="拒收处理"
                       align="center"
                       width="120"
                       prop="jscl"></el-table-column>
    ...
    <el-dialog :title="title"
      ...
      <el-form :model="materielQueryParams"
        ...
        <el-form-item label="订单号"
                      prop="orderNum">
          <el-input v-model="materielQueryParams.orderNum"
                    placeholder="请输入订单号"
                    size="small"
                    style="width: 150px"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="技术要求">
              <el-input v-model="form.jsyq"
                        :disabled="true"
                        placeholder="请输入技术要求"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="签收数">
              <el-input v-model="form.jsyq"
                        placeholder="请输入签收数"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  watch: {
    $route (to, form) {
      this.isShow = to.params.isShow || false;
      this.isAudit = to.params.isAudit || false;
      this.isUnAudit = to.params.isUnAudit || false;
  ...
  created () {
    ...
    this.isShow = this.$route.params.isShow || false;
    this.isAudit = this.$route.params.isAudit || false;
    this.isUnAudit = this.$route.params.isUnAudit || false;
  },
  methods: {
    getList () {
