<template>
    <div class="container">
        ...
        <div class="handle-box">
            <el-button type="primary" size="small" icon="el-icon-paperclip" class="handle-del mr10" v-show="isShow" @click="handleAddClientele">客户</el-button>
        </div>
        <el-form :model="clienteleForm" ref="clienteleForm" :rules="rules" label-position="right" label-width="auto" :inline="true">
            <el-row>
                <el-col :span="4">
                    <el-form-item label="报价单号" prop="quotationNum">
                        <el-input v-model="quotationNum" size="mini" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="客户编码" prop="clienteleNum">
                        <el-input v-model="clienteleForm.clienteleNum" maxlength="10" show-word-limit size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="客户名称" prop="clienteleName">
                        <el-input v-model="clienteleForm.clienteleName" clearable size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="客户类别" :readonly="!isShow" prop="categoryId">
                        <treeselect
                            :disabled="!isShow"
                ...
                <el-col :span="4">
                    <el-form-item label="联系人" prop="leader">
                        <el-input v-model="clienteleForm.leader" clearable size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="联系电话" prop="phone">
                        <el-input v-model="clienteleForm.phone" clearable:readonly="!isShow" size="small" style="width: 155px;" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="4">
                    <el-form-item label="手机" prop="mobilephone">
                        <el-input v-model="clienteleForm.mobilephone" clearable size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="邮箱" prop="email">
                        <el-input v-model="clienteleForm.email" size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="法人" prop="legalPerson">
                        <el-input v-model="clienteleForm.legalPerson" size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="社会信用号" prop="certificateNum">
                        <el-input v-model="clienteleForm.certificateNum" size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="地址" prop="address">
                        <el-input v-model="clienteleForm.address" size="small" :readonly="!isShow" style="width: 420px" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="总计金额" prop="totalPrice">
                        <el-input v-model="clienteleForm.totalPrice" size="small" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="报价日期" prop="quotationTime">
                        <el-date-picker v-model="clienteleForm.quotationTime" style="width:155px;" value-format="yyyy-MM-dd" format="yyyy-MM-dd" :readonly="!isShow" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="过期时间" prop="effectiveTime">
                        <el-date-picker v-model="clienteleForm.effectiveTime" style="width:155px;" value-format="yyyy-MM-dd" format="yyyy-MM-dd" :readonly="!isShow" placeholder="选择日期" />
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="报价人" prop="personnelName">
                        <el-input v-model="clienteleForm.personnelName" size="small" suffix-icon="el-icon-search" :readonly="!isShow" style="width: 155px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="付款条件" prop="payCondition">
                        <el-input v-model="clienteleForm.payCondition" placeholder="请输入付款条件" size="small" :readonly="!isShow" style="width: 420px" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="clienteleForm.remark" type="textarea" autosize :readonly="!isShow" style="width: 1000px" size="small" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <div class="handle-box">
            <el-button type="primary" size="small" icon="el-icon-plus" class="handle-del mr10" v-show="isShow" @click="handleAddMateriel">新增产品</el-button>
        ...
        <el-table v-loading="loading" :data="materielListData">
            ...
            <el-table-column prop="number" label="数量" align="center" :show-overflow-tooltip="true"> </el-table-column>
            <el-table-column prop="totalPrice" label="金额" align="center" :show-overflow-tooltip="true"> </el-table-column>
            <el-table-column prop="demand" label="技术要求" width="300" align="center" :show-overflow-tooltip="true"> </el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="linkMaterielOpen" width="800px" append-to-body>
            ...
            <el-table v-loading="linkMaterielLoading" :data="linkMaterielListData" highlight-current-row @row-dblclick="clickSelectionMateriel" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="specification" label="规格" :show-overflow-tooltip="true" align="center"></el-table-column>
                <el-table-column prop="modelName" label="型号" :show-overflow-tooltip="true" align="center"></el-table-column>
                <el-table-column prop="needTorque" label="所需扭矩" align="center"></el-table-column>
                <el-table-column prop="outTorque" label="输出扭矩" align="center"></el-table-column>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="产品类别" prop="categoryId">
                            <treeselect v-model="form.categoryId" :options="materileTypeOptions" :disable-branch-nodes="true" :show-count="true" placeholder="请选择产品类别" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
...
<script>
import { addQuotation, getQuotation, auditQuotation } from '@/api/sales/quotation.js';
import { listQuotationSub, addQuotationSub, updateQuotationSub, deleteQuotationSub } from '@/api/sales/quotation.js';
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                effectiveTime: [{ required: true, message: '过期日期不能为空', trigger: 'blur' }],
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/sales/quotation/preview' && this.quotationId !== to.query.id) {
                this.quotationId = to.query.id;
    ...
    methods: {
        ...
        // 上传图片
        handleUpload(row) {
            this.fileQuery.subId = row.subId;
            listAccessory(this.fileQuery).then(res => {
                this.title = '图纸';
                this.uploadOpen = true;
                this.imageLoading = false;
                this.imageListData = res.data.records;
                this.fileTotal = res.data.total;
                this.actionUrl = process.env.VUE_APP_BASE_API + '/sales/accessory/upload/' + row.subId;
            });
        },
        getMaterielFile() {
            listAccessory(this.fileQuery).then(res => {
        ...
        handleRemoveFile(row) {
            deleteAccessory(row.pkId).then(res => {
                if (res.success) {
                    this.msgSuccess(res.message);
                    this.getMaterielFile();
                } else {
