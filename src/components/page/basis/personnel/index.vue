      ...
      <el-col :span="20"
        ...
        <el-form :model="queryParams"
          ...
          <el-form-item label="在职状态"
            ...
            <el-select v-model="queryParams.jobStatus"
                       ...
                       size="small"
                       style="width: 140px">
              <el-option v-for="dict in jobStatusOptions"
                         :key="dict.dictValue"
        ...
        <div class="handle-box">
          <el-button type="primary"
                     ...
                     v-hasPermi="['basis:personnel:add']"
          ...
          <el-table-column label="操作"
            ...
            <template slot-scope="scope">
              <el-button size="mini"
                         type="text"
                         icon="el-icon-edit"
                         v-hasPermi="['basis:personnel:edit']"
    ...
    <el-dialog :title="title"
      ...
      <el-form ref="form"
          ...
          <el-col :span="12">
            <el-form-item label="系统用户"
              ...
              <el-radio-group v-model="form.userType">
                <el-radio v-for="dict in userTypeOptions"
                          :key="dict.dictValue"
          ...
          <el-col :span="12">
            <el-form-item label="性别">
              <el-select v-model="form.gender"
                         clearable
                         placeholder="请选择性别">
                <el-option v-for="dict in genderOptions"
                           :key="dict.dictValue"
                           :label="dict.dictLabel"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="是在在职"
                          prop="jobStatus">
              <el-radio-group v-model="form.jobStatus">
                <el-radio v-for="dict in jobStatusOptions"
                          :key="dict.dictValue"
                          :label="dict.dictValue">{{ dict.dictLabel }}</el-radio>
              </el-radio-group>
            </el-form-item>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="现住址"
                          prop="nowAddress">
              <el-input v-model="form.nowAddress"
                        placeholder="请输入现住址" />
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  data () {
    return {
      ...
      // 在职状态数据字典
      jobStatusOptions: [{ dictValue: '0', dictLabel: '在职' }, { dictValue: '1', dictLabel: '离职' }],
      //是否为系统员工
