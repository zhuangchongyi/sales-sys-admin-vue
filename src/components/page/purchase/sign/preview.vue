...
<script>
import { auditPurchaseSign, getPurchaseSign, listPurchaseSignSub } from '@/api/purchase/sign.js';
...
export default {
    ...
    watch: {
        $route(to, form) {
            if (to.path === '/page/purchase/sign/preview' && this.supplierForm.signId !== this.$route.query.id) {
                this.getPurchaseSignData();
            }
        }
    },
