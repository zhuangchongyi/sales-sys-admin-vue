    ...
    <div>
        <div class="container">
            ...
            <div class="handle-box">
                <el-button type="primary" size="small" icon="el-icon-plus" class="handle-del mr10" @click="handleAdd" v-hasPermi="['warehouse:inventory:add']">新增</el-button>
                <el-dropdown trigger="click" style="margin: 0 10px;" v-hasPermi="['warehouse:inventory:submit']">
                ...
                <el-button type="primary" size="small" icon="el-icon-finished" class="handle-del mr10" :disabled="single" @click="handleAudit" v-hasPermi="['warehouse:inventory:audit']"
                    >审核</el-button
                >
            </div>
            <el-table
            ...
            >
                ...
                <el-table-column label="操作" width="150" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['warehouse:inventory:edit']">修改</el-button>
                        <el-button type="text" icon="el-icon-delete" style="color:#fd5656" @click="handleDelete(scope.row)" v-hasPermi="['warehouse:inventory:delete']">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
